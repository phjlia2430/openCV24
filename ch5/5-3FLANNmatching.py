...
print(bf_knn_matches[0][0].queryIdx,bf_knn_matches[0][1].trainIdx)

T=0.7
good_match=[]
for nearest1,nearest2 in bf_knn_matches:
#    if nearest1.distance< T: # 1)고정임계값 2)최근접 이웃 거리 비율 전략
...
#NOT_DRAW_SINGLE_POINTS는 매칭 안된거는 안 그림
